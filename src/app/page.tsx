...
export default function Home() {
  return (
    <main className='flex flex-col items-center justify-center min-h-screen p-4 bg-gradient-to-b from-gray-50 to-white'>
      <div className='max-w-2xl w-full space-y-8'>
        <div className='text-center space-y-4'>
          <h1 className='text-3xl sm:text-5xl font-bold text-gray-800 mb-1 sm:mb-2'>Puffit（Shisha ver.）</h1>
